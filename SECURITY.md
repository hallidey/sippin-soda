...
This project is pre-release and is intended for controlled development traffic. The proxy binds to IPv4 loopback only after explicit Start. It installs no CA and never changes system proxy settings. HTTPS/CONNECT and protocol upgrades are unsupported.
