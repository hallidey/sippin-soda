...
| --- | --- | --- | --- |
| Desktop foundation | v0.1 | Tauri/React scaffold, theme and versioned local workspace settings, honest empty states | UI build; CI native compilation; proxy setup survives app restart without persisting secrets or HTTPS opt-in |
