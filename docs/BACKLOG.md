...
| --- | --- | --- | --- |
| Desktop foundation | v0.1 | Tauri/React scaffold, theme, versioned local workspace settings and unsigned per-user Windows installer | UI build; CI native compilation; proxy setup survives app restart without persisting secrets or HTTPS opt-in; manual workflow emits an NSIS artifact |
